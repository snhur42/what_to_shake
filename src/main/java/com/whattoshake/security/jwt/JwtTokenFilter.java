package com.whattoshake.security.jwt;

import com.whattoshake.exception.controller.JwtAuthenticationException;
...
public class JwtTokenFilter extends GenericFilterBean {
    ...
    @Autowired
    public JwtTokenFilter(@Qualifier("jwtAccessTokenProvider") JwtAccessTokenProvider jwtAccessTokenProvider) {
